module top (busy,
 ...
 sky130_fd_sc_hd__inv_2 _128_ (.A(net19),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__inv_2 _129_ (.A(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _130_ (.A(net34),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__inv_2 _131_ (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _189_ (.A(\baud_inst.cnt[9] ),
    ...
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__o211a_1 _190_ (.A1(net37),
    .A2(_096_),
    .B1(_097_),
    .C1(_083_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _226_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\baud_inst.cnt[5] ));
 sky130_fd_sc_hd__dfrtp_1 _227_ (.CLK(clknet_2_1__leaf_clk),
    .D(_014_),
    .RESET_B(_025_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _228_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\baud_inst.cnt[7] ));
 sky130_fd_sc_hd__dfrtp_1 _229_ (.CLK(clknet_2_1__leaf_clk),
    .D(_016_),
    .RESET_B(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\baud_inst.cnt[8] ));
 sky130_fd_sc_hd__dfrtp_1 _230_ (.CLK(clknet_2_1__leaf_clk),
    .D(_017_),
    .RESET_B(_028_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\baud_inst.cnt[9] ));
 sky130_fd_sc_hd__dfrtp_1 _231_ (.CLK(clknet_2_1__leaf_clk),
    .D(_006_),
    .RESET_B(_029_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\baud_inst.cnt[10] ));
 sky130_fd_sc_hd__dfrtp_1 _232_ (.CLK(clknet_2_1__leaf_clk),
    .D(_007_),
    .RESET_B(_030_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _244_ (.CLK(clknet_2_2__leaf_clk),
    .D(_054_),
    .RESET_B(_042_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _246_ (.CLK(clknet_2_2__leaf_clk),
    .D(_056_),
    .RESET_B(_044_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _247_ (.CLK(clknet_2_2__leaf_clk),
    .D(_057_),
    .RESET_B(_045_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _248_ (.CLK(clknet_2_2__leaf_clk),
    .D(_058_),
    .RESET_B(_046_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _249_ (.CLK(clknet_2_2__leaf_clk),
    .D(_059_),
    .RESET_B(_047_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold13 (.A(\baud_inst.cnt[1] ),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold14 (.A(\uart_tx_inst.cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(\baud_inst.cnt[7] ),
    ...
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\baud_inst.cnt[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(\baud_inst.cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(\baud_inst.cnt[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_6_27 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_6_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_16_117 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_4 FILLER_17_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
